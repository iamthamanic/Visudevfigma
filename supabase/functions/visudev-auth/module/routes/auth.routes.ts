...
export function registerAuthRoutes(
  ...
  app.post(
    "/github/session",
    asyncHandler(controller.githubSession.bind(controller)),
  );
  app.post(
    "/github/repos",
    asyncHandler(controller.githubRepos.bind(controller)),
  );
  app.post(
    "/supabase/validate",
    asyncHandler(controller.supabaseValidate.bind(controller)),
  );
  app.post(
    "/supabase/projects",
    asyncHandler(controller.supabaseProjects.bind(controller)),
  );
}
