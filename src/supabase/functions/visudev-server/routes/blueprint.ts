...
import { projectIdParamSchema, withValidatedParam } from "../lib/params.ts";
    ...
    withValidatedParam(
      ...
      async (projectId) => {
        try {
          ...
          c.get("logError")("Error fetching blueprint.", error);
    ...
    withValidatedParam(
      ...
      async (projectId) => {
        try {
          ...
          c.get("logError")("Error updating blueprint.", error);
          return c.json({ success: false, error: "Internal error" }, 500);
        }
      },
    ),
