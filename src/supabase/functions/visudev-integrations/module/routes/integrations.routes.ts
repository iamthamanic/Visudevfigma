...
export function registerIntegrationsRoutes(
  ...
  app.get(
    "/:projectId",
    asyncHandler(controller.getIntegrations.bind(controller)),
  );
  app.put(
    "/:projectId",
    asyncHandler(controller.updateIntegrations.bind(controller)),
  );
  ...
  app.get(
    "/:projectId/github/content",
    asyncHandler(controller.getGitHubContent.bind(controller)),
  );
  app.delete(
    "/:projectId/github",
    asyncHandler(controller.disconnectGitHub.bind(controller)),
  );

  app.post(
    "/:projectId/supabase",
    asyncHandler(controller.connectSupabase.bind(controller)),
  );
  app.get(
    "/:projectId/supabase",
    asyncHandler(controller.getSupabaseInfo.bind(controller)),
  );
  app.delete(
    "/:projectId/supabase",
    asyncHandler(controller.disconnectSupabase.bind(controller)),
  );
}
