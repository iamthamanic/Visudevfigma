...
import { FlowNode, FlowEdge, UIElement, DBTable, DBRelation, DBPolicy, Migration, WebhookEvent, Project } from './types';
...
export const mockFlowNodes: FlowNode[] = [
  // Login Flow
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/a3f4b2c/src/components/LoginForm.tsx#L45-L52'
    },
    layer: 'frontend'
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/a3f4b2c/src/components/LoginForm.tsx#L28-L35'
    },
    layer: 'frontend'
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/a3f4b2c/supabase/functions/server/routes/auth.ts#L12-L34',
  ...
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/a3f4b2c/supabase/functions/server/routes/auth.ts#L15-L18',
  ...
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/a3f4b2c/supabase/functions/server/routes/auth.ts#L22-L25',
  ...
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/a3f4b2c/supabase/migrations/20240101_rls.sql#L12-L14',
  ...
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/a3f4b2c/supabase/functions/server/integrations/erp.ts#L8-L18'
    },
    layer: 'external'
  },
  ...
  // Order Flow
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/b7e9d1a/src/components/CheckoutForm.tsx#L67-L74'
    },
    layer: 'frontend'
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/b7e9d1a/supabase/functions/server/routes/orders.ts#L18-L52',
      open_in_supabase: 'https://supabase.com/dashboard/project/_/functions/server'
    },
    layer: 'compute'
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/b7e9d1a/supabase/functions/server/routes/orders.ts#L26-L29',
      open_in_supabase: 'https://supabase.com/dashboard/project/_/editor'
    },
    layer: 'data'
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/b7e9d1a/supabase/functions/server/routes/orders.ts#L32-L36',
      open_in_supabase: 'https://supabase.com/dashboard/project/_/editor'
    },
    layer: 'data'
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/b7e9d1a/supabase/migrations/20240102_orders_rls.sql#L8-L10',
      open_in_supabase: 'https://supabase.com/dashboard/project/_/auth/policies'
    },
    layer: 'policies'
  },
  {
    ...
    code_snippet: `async function createSalesOrder(orderId: string, items: any[]) {\n  const response = await fetch(ERP_API + '/sales-orders', {\n    method: 'POST',\n    headers: { 'Authorization': \`Bearer \${ERP_TOKEN}\` },\n    body: JSON.stringify({ orderId, items })\n  });\n  return response.json();\n}`,
    metrics: { avg_ms: 312, p95_ms: 680, err_rate: 0.12 },
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/b7e9d1a/supabase/functions/server/integrations/erp.ts#L32-L45'
    },
    layer: 'external'
  },
  {
    ...
    links: {
      github_permalink: 'https://github.com/acme-corp/shop-frontend/blob/b7e9d1a/supabase/functions/server/routes/orders.ts#L45-L48',
...
export const mockFlowEdges: FlowEdge[] = [
  // Login Flow
  { id: 'e1', source: 'node-login-ui', target: 'node-validate', kind: 'request', label: 'validate' },
  { id: 'e2', source: 'node-validate', target: 'node-api-login', kind: 'request', label: 'POST' },
  { id: 'e3', source: 'node-api-login', target: 'node-auth-signin', kind: 'request', label: 'auth' },
  { id: 'e4', source: 'node-auth-signin', target: 'node-sql-profile', kind: 'sql', label: 'query' },
  { id: 'e5', source: 'node-sql-profile', target: 'node-policy-profile', kind: 'policy', label: 'enforce' },
  { id: 'e6', source: 'node-api-login', target: 'node-erp-contact', kind: 'request', label: 'sync' },
  
  // Order Flow
  { id: 'e7', source: 'node-order-ui', target: 'node-edge-order', kind: 'request', label: 'POST' },
  { id: 'e8', source: 'node-edge-order', target: 'node-sql-inventory', kind: 'sql', label: 'check' },
  { id: 'e9', source: 'node-edge-order', target: 'node-sql-orders-insert', kind: 'sql', label: 'insert' },
  { id: 'e10', source: 'node-sql-orders-insert', target: 'node-policy-orders', kind: 'policy', label: 'enforce' },
  { id: 'e11', source: 'node-edge-order', target: 'node-erp-sales', kind: 'request', label: 'sync' },
  { id: 'e12', source: 'node-edge-order', target: 'node-storage-invoice', kind: 'request', label: 'upload' }
];

export const mockTables: DBTable[] = [
  { id: 't1', schema_name: 'public', table_name: 'profiles', columns: ['id', 'user_id', 'name', 'email'] },
  { id: 't2', schema_name: 'public', table_name: 'orders', columns: ['id', 'user_id', 'status', 'created_at'] },
  { id: 't3', schema_name: 'public', table_name: 'order_items', columns: ['id', 'order_id', 'product_id', 'quantity'] },
  { id: 't4', schema_name: 'public', table_name: 'products', columns: ['id', 'name', 'price', 'category'] },
  { id: 't5', schema_name: 'public', table_name: 'inventory', columns: ['id', 'product_id', 'quantity', 'warehouse'] },
  { id: 't6', schema_name: 'public', table_name: 'projects', columns: ['id', 'name', 'created_by'] },
  { id: 't7', schema_name: 'public', table_name: 'members', columns: ['project_id', 'user_id', 'role'] }
];

export const mockRelations: DBRelation[] = [
  { id: 'r1', src_table: 'profiles', src_column: 'user_id', dst_table: 'auth.users', dst_column: 'id' },
  { id: 'r2', src_table: 'orders', src_column: 'user_id', dst_table: 'auth.users', dst_column: 'id' },
  { id: 'r3', src_table: 'order_items', src_column: 'order_id', dst_table: 'orders', dst_column: 'id' },
  { id: 'r4', src_table: 'order_items', src_column: 'product_id', dst_table: 'products', dst_column: 'id' },
  { id: 'r5', src_table: 'inventory', src_column: 'product_id', dst_table: 'products', dst_column: 'id' },
  { id: 'r6', src_table: 'members', src_column: 'project_id', dst_table: 'projects', dst_column: 'id' },
  { id: 'r7', src_table: 'members', src_column: 'user_id', dst_table: 'auth.users', dst_column: 'id' }
];
...
export const mockPolicies: DBPolicy[] = [
  ...
  },
  {
    ...
    roles: ['authenticated'],
    using_sql: 'EXISTS (SELECT 1 FROM orders WHERE orders.id = order_items.order_id AND orders.user_id = auth.uid())',
    check_sql: undefined
  },
  {
    id: 'p6',
  ...
  },
  {
    ...
    roles: ['authenticated'],
    using_sql: 'EXISTS (SELECT 1 FROM members m WHERE m.project_id = members.project_id AND m.user_id = auth.uid())',
    check_sql: undefined
  }
];

export const mockMigrations: Migration[] = [
  { id: '1', name: '20240101_initial_schema.sql', sha: 'a1b2c3d', applied_at: '2024-01-01T10:00:00Z' },
  { id: '2', name: '20240101_rls.sql', sha: 'a3f4b2c', applied_at: '2024-01-01T11:30:00Z' },
  { id: '3', name: '20240102_orders_tables.sql', sha: 'b7e9d1a', applied_at: '2024-01-02T09:15:00Z' },
  ...
  { id: '6', name: '20240105_projects_visudev.sql', sha: 'e9f1a3b', applied_at: '2024-01-05T16:00:00Z' }
];
